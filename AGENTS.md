...
- **Current version**: v5.16.9 (Transfers + Chip Strategy sections moved to the very top of the Squad tab so actionable chip/transfer advice is the first thing visible; amber "OPTIMAL DRAFT, not your actual squad" banner when the selected GW has no FPL picks yet)
