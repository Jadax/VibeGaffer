...
- **Current version**: v5.16.10 (Transfers + Chip Strategy moved to the very top of the Squad tab so actionable advice is first; pitch inverted per the author's explicit request — GK now at the TOP and FWD at the bottom, the OPPOSITE of the official FPL orientation; amber "OPTIMAL DRAFT" banner when the selected GW has no FPL picks yet)
